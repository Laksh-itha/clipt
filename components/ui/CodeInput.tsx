  ...
  return (
    <div className="p-4 border border-[#e5d9ce]  bg-white/50 dark:bg-[#0f0f1a] rounded-lg w-150">
      <div className="flex items-center gap-2 mb-2">
        <h6 className="text-md font-semibold tracking-widest  text-[#7a6a5e] dark:text-[#888888]">
      ...
      <input
        className="w-full h-12 px-4 border border-[#e5d9ce]  rounded-lg text-[#3a3028] dark:text-[#e8e8f4] font-bold tracking-widest placeholder:text-[#d5ccc4] dark:placeholder:text-[#444444] placeholder:font-normal placeholder:normal-case focus:outline-none focus:border-[#5a7a4a] dark:focus:border-[#c8f542] transition-colors bg-transparent text-sm"
        ...
        maxLength={20}
      />
      <h6 className="text-xs font-semibold tracking-widest text-[#b0a090] dark:text-[#888888] mt-2">
