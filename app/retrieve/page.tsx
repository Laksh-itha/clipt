    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="text-left mb-8 sm:mb-10">
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-[#3a3028] dark:text-[#e8e8f4] leading-tight">
            Enter your
          </h1>
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-[#8aac62] leading-tight">
            clip code.
          </h1>
        ...
        <div className="space-y-3">
          <div className="border border-[#e5d9ce] dark:border-[#1c1c2e] rounded-xl p-4 sm:p-5 bg-white/50 dark:bg-[#0f0f1a]">
            <p className="text-xs font-semibold tracking-widest text-[#7a6a5e] dark:text-[#888888] mb-3">
              Your Access Code
            </p>
            <input
              className="w-full h-12 px-4 border border-[#e5d9ce] dark:border-[#1c1c2e] rounded-lg text-[#3a3028] dark:text-[#e8e8f4] font-bold tracking-widest placeholder:text-[#d5ccc4] dark:placeholder:text-[#888888] placeholder:font-normal placeholder:normal-case focus:outline-none focus:border-[#5a7a4a] dark:focus:border-[#c8f542] transition-colors bg-transparent text-sm"
            ...
            />
            {error && (
              <p className="text-red-400 text-xs font-semibold mt-2 tracking-wide">✗ {error}</p>
            )}
          </div>
          ...
          <button
            ...
            className={`w-full h-12 rounded-xl text-xs font-bold tracking-widest uppercase transition-all ${
              code.trim().length >= 4 && !loading
                ? "bg-[#5a7a4a] dark:bg-[#c8f542] text-white dark:text-[#09090f] hover:bg-[#4a6a3a] cursor-pointer"
          ...
          <p className="text-center text-xs text-[#b0a090] dark:text-[#888888] tracking-wide pt-1">
            ...
            <span className="text-[#7a6a5e] dark:text-[#888888] font-semibold">
              clipt.io/YOURCODE
            </span>{" "}
            directly
          </p>
